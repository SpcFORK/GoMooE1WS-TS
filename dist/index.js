...
var require_bp = __commonJS({
  "src/bp-gm1/bp.js"(exports, module2) {
    "use strict";
    ...
    var require_cowrle = __commonJS2({
      "src/encode/bullpress/cowrle.js"(exports2, module22) {
        ...
        if (typeof module22 !== "undefined")
          module22.exports = eobj2;
      }
    });
    var require_BWT = __commonJS2({
      "src/encode/bullpress/BWT.js"(exports2, module22) {
    ...
    var require_huffman = __commonJS2({
      "src/encode/bullpress/huffman.js"(exports2, module22) {
    ...
    var require_cst = __commonJS2({
      "src/encode/bullpress/blocks/cst.js"(exports2, module22) {
    ...
    var require_casing = __commonJS2({
      "src/encode/bullpress/blocks/casing.js"(exports2, module22) {
        var eobj2 = {
    ...
    var require_avoidE = __commonJS2({
      "src/encode/bullpress/blocks/avoidE.js"(exports2, module22) {
        var eobj2 = {
          encode(input) {
            const caser = (_) => `(${_})`;
    ...
    var require_bracketE = __commonJS2({
      "src/encode/bullpress/blocks/bracketE.js"(exports2, module22) {
        var eobj2 = {
          encode(input) {
    ...
    var require_base64 = __commonJS2({
      "src/encode/bullpress/blocks/base64.js"(exports2, module22) {
        var base6422 = {
        ...
        else if (typeof module22 !== "undefined")
          module22.exports = base6422;
      }
    });
    var require_bullpress = __commonJS2({
      "src/encode/bullpress/bullpress.js"(exports2, module22) {
...
__export(bpws_exports, {
  ...
  moduleToIIFE: () => moduleToIIFE,
  packScriptTagInvoker: () => packScriptTagInvoker,
...
function unpackDocument(doc) {
  if (typeof doc === "string")
    doc = new import_jsdom.JSDOM(doc);
...
function createCompressionRoute(app, cb) {
  ...
  app.get("/bpws/compress/:file", (req, res) => {
    ...
    if (cbTemp !== false) {
      ...
      var tempContent = Object.assign({}, comp_content);
